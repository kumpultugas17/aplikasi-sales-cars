         ...
         <div class="page-content">
            <div class="d-flex flex-column flex-lg-row mb-2">
               ...
               <div class="flex-grow-1">
                  <h5 class="page-title">Create Cars</h5>
               </div>
               <div class="pt-lg-1">
            ...
            <div class="bg-white rounded-2 shadow-sm p-4 mb-5">
               ...
               <form action="act_car_add.php" method="POST">
                  ...
                  <div class="mb-3 row align-items-center">
                     <label class="form-label col-sm-2">Model <span class="text-danger">*</span></label>
                     <div class="col-sm-10">
                        <input type="text" name="model" class="form-control" autocomplete="off">
                     </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                     <label class="form-label col-sm-2">Year <span class="text-danger">*</span></label>
                     <div class="col-sm-10">
                        <input type="text" name="year" class="form-control" autocomplete="off">
                     </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                     <label class="form-label col-sm-2">Price <span class="text-danger">*</span></label>
                     <div class="col-sm-10">
